...
typedef enum
{
	...
	SENSOR_PEDOMETER_STEP,                   /**< Pedometer step count */
	SENSOR_BIO,                              /**< Bio sensor */
	SENSOR_BIO_HRM,                          /**< Bio HRM sensor */
 ...
 * sensor_bio_event_cb(), sensor_bio_hrm_event_cb(),
 ...
 * @}
 *
 * @addtogroup CAPI_SYSTEM_SENSOR_PEDOMETER_STOP
 * @{
 */

/**
 * @brief Called when a pedometer step event occurs.
 * @details
 * This event occurs when walking or running
 * @image html pedometer_step_count.png
 * This Pedometer event will fire only when the step event occures
 *
 * @param[in] timestamp     The time in nanosecond at which the event ahppened
 * @param[in] user_data     The user data passed from the callback registration function
 * @pre sensor_start() will invoke this callback if you register this callback using sensor_pedometer_step_set_cb().
 * @see sensor_pedometer_step_set_cb()
 * @see sensor_pedometer_step_unset_cb()
 */
typedef void (*sensor_pedometer_step_event_cb) ( unsigned long long timestamp, int event, void *user_data);

/**
 * @brief       Registers a callback function to be invoked when a pedometer step event occurs.
 *
 * @param[in]   sensor      The sensor handle
 * @param[in]   callback    The callback function to register
 * @param[in]   user_data   The user data to be passed to the callback function
 ...
 * @retval      #SENSOR_ERROR_OPERATION_FAILED      Operation failed
 *
 * @post sensor_pedometer_step_event_cb() will be invoked.
 *
 * @see sensor_pedometer_step_event_cb()
 * @see sensor_pedometer_step_unset_cb()
 */
int sensor_pedometer_step_set_cb(sensor_h sensor, sensor_pedometer_step_event_cb callback, void *user_data);


/**
 * @brief       Unregister the step event callback function.
 *
 * @param[in]   sensor     The sensor handle
 *
 * @return      0 on success, otherwise a negative error value
 ...
 * @see sensor_pedometer_step_set_cb()
 */
int sensor_pedometer_step_unset_cb(sensor_h sensor);


/**
 * @brief Gets sensor data from the Pedometer step sensor.
 *
 * @remark
 * All values are stop count.
 *
 * @param[in]   sensor      The sensor handle
 * @param[out]  step_count    The measured step count
 *
 * @return      0 on success, otherwise a negative error value
 * @retval      #SENSOR_ERROR_NONE                  Successful
 * @retval      #SENSOR_ERROR_INVALID_PARAMETER     Invalid parameter
 ...
 * @see sensor_start()
 */
int sensor_pedometer_step_read_data(sensor_h sensor, int* step_count);

/**
 * @}
 *
 * @addtogroup CAPI_SYSTEM_SENSOR_BIO_MODULE
 * @{
 */

/**
 * @brief Called when an bio event occurs.
 *
 * @param[in] timestamp     The time in nanosecond at which the event happened
 * @param[in] raw1
 * @param[in] raw2
 * @param[in] raw3
 * @param[in] user_data     The user data passed from the callback registration function
 *
 * @pre sensor_start() will invoke this callback if you register this callback using sensor_bio_set_cb().
 *
 * @see sensor_bio_set_cb()
 * @see sensor_bio_unset_cb()
 */
typedef void (*sensor_bio_event_cb)( unsigned long long timestamp,
		int raw1, int raw2, int raw3, void *user_data);


/**
 * @brief	Registers a callback function to be invoked when an bio event occurs.
 *
 * @param[in]   sensor      The sensor handle
 * @param[in]   interval_ms	The interval sensor events are delivered at (in milliseconds) \n
 *							If @a rate is zero, it uses default value(100ms)
 ...
 * @retval      #SENSOR_ERROR_OPERATION_FAILED      Operation failed
 *
 * @post sensor_bio_event_cb() will be invoked.
 *
 * @see sensor_bio_event_cb()
 * @see sensor_bio_unset_cb()
 */
int sensor_bio_set_cb(sensor_h sensor, int interval_ms, sensor_bio_event_cb callback, void *user_data);


/**
 * @brief	Unregister the bio callback function.
 *
 * @param[in]   sensor     The sensor handle
 *
 * @return      0 on success, otherwise a negative error value
 ...
 * @see sensor_bio_set_cb()
 */
int sensor_bio_unset_cb(sensor_h sensor);

/**
 * @brief change the interval at bio measurements.
 *
 * @param[in]   sensor          The sensor handle
 * @param[in]   interval_ms     in milliseconds.
 *
 ...
 * @see sensor_bio_set_cb()
 */
int sensor_bio_set_interval(sensor_h sensor, int interval_ms);


/**
 * @brief	Gets sensor data from the bio sensor.
 *
 * @param[in]   sensor      The sensor handle
 * @param[out]  raw1
 * @param[out]  raw2
 ...
 * @pre In order to read sensor data, an application should call sensor_start().
 */
int sensor_bio_read_data(sensor_h sensor, int *raw1, int *raw2, int *raw3);

/**
 * @}
 *
 * @addtogroup CAPI_SYSTEM_SENSOR_BIO_HRM_MODULE
 * @{
 */

/**
 * @brief Called when a Bio HRM event occurs.
 *
 * @param[in] timestamp     The time in nanosecond at which the event happened
 * @param[in] hr
 * @param[in] spo2
 * @param[in] peek_to_peek
 * @param[in] snr
 *
 * @pre sensor_start() will invoke this callback if you register this callback using sensor_bio_hrm_set_cb().
 * @see sensor_bio_hrm_set_cb()
 * @see sensor_bio_hrm_unset_cb()
 */
typedef void (*sensor_bio_hrm_event_cb) ( unsigned long long timestamp,
		int hr, int spo2, int peek_to_peek, float snr, void *user_data);

/**
 * @brief       Registers a callback function to be invoked when a bio hrm event occurs.
 *
 * @param[in]   sensor      The sensor handle
 * @param[in]   callback    The callback function to register
 * @param[in]   user_data   The user data to be passed to the callback function
 ...
 * @retval      #SENSOR_ERROR_OPERATION_FAILED      Operation failed
 *
 * @post sensor_bio_hrm_event_cb() will be invoked.
 *
 * @see sensor_bio_hrm_event_cb()
 * @see sensor_bio_hrm_unset_cb()
 */
int sensor_bio_hrm_set_cb(sensor_h sensor, sensor_bio_hrm_event_cb callback, void *user_data);


/**
 * @brief       Unregister the bio hrm event callback function.
 *
 * @param[in]   sensor     The sensor handle
 *
 * @return      0 on success, otherwise a negative error value
 ...
 * @see sensor_bio_hrm_set_cb()
 */
int sensor_bio_hrm_unset_cb(sensor_h sensor);


/**
 * @brief Gets sensor data from the Bio HRM sensor.
 *
 * @param[in]   sensor      The sensor handle
 * @param[out]  hr
 * @param[out]  spo2
 * @param[out]  peek_to_peek
 * @param[out] 	snr
 *
 * @return      0 on success, otherwise a negative error value
 * @retval      #SENSOR_ERROR_NONE                  Successful
 ...
 * @see sensor_start()
 */
int sensor_bio_hrm_read_data(sensor_h sensor, int *hr, int *spo2, int *peek_to_peek, float *snr);
